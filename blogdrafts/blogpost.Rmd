...
Using R presents some challenges, and it took some planning to organize simulation elements. I managed to make progress with just a couple of amazing R libs, `grid` and `svDialogs`.
